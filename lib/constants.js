...
export function longEmp(short) {
    var long = Object.values(getLocations())
        .flat(1)
        .map(e => [e.replaceAll(/[^A-Z&0-9]/g, ""), e])
        .filter(e => e[0].toLowerCase() == short.toLowerCase())
        .map(e => e[1]);
    return long || short;
}
...
export function jobReqs() {
    // from https://github.com/danielyxie/bitburner/blob/dev/src/Company/data/CompanyPositionsMetadata.ts
    return {
        "software": [
...
export function companyReqOffset() {
    return {
        "ECorp": 249,
        "MegaCorp": 249,
        "BachmanAndAssociates": 224,
        "BladeIndustries": 224,
        "NWO": 249,
        "ClarkeIncorporated": 224,
        "OmniTekIncorporated": 224,
        "FourSigma": 224,
        "KuaiGongInternational": 224,
        "FulcrumTechnologies": 224,
        "StormTechnologies": 199,
        "TokyoDefComm": 199,
        "HeliosLabs": 199,
        "TokyoVitaLife": 199,
        "IcarusMicrosystems": 199,
        "UniversalEnergy": 199,
        "GalacticCybersystems": 199,
        "AeroCorp": 199,
        "OmniaCybersystems": 199,
        "SolarisSpaceSystems": 199,
        "DeltaOne": 199,
        "TokyoGlobalPharmaceuticals": 224,
        "NovaMedical": 199,
        "CIA": 149,
        "NSA": 149,
        "WatchdogSecurity": 124,
        "LexoCorp": 99,
        "RhoConstruction": 49,
        "AlphaEnterprises": 99,
        "Police": 99,
        "SysCoreSecurities": 124,
        "CompuTek": 74,
        "NetLinkTechnologies": 99,
        "CarmichaelSecurity": 74,
        "FoodNStuff": 0,
        "JoesGuns": 0,
        "OmegaSoftware": 49,
        "TokyoNoodleBar": 0,
